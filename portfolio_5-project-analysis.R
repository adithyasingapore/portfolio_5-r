...
# Running the "unique" command returns only 2 values, '0' and '1'.
...
# The 95% confidence interval shows an age difference ranging
# between 17 and 24 years (younger).
# p-value is less than 2.2e-16
# normally, if p-value is less than 0.05, null hypothesis is rejected
# Results are statistically significant.
# Hypothesis 1 valid, patients who died are indeed older.
...
# p-value 0.002 is less than 0.05, so this is statistically significant.
# So null hypothesis is rejected and Hypothesis 2 is also valid.
...
# (A) Sufficient number of case entries in the data set for each country.
...
# With 99% confidence, South Korea has between 2% less and 12.5% more
# deaths than Japan. But p-value is 0.06, which is more than 0.05.
# Therefore the statistical significance is questionable.
